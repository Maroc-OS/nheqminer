...
NotePlaintext::NotePlaintext(const Note &note,
...
NotePlaintext
NotePlaintext::decrypt(const ZCNoteDecryption &decryptor,
                       const ZCNoteDecryption::Ciphertext &ciphertext,
                       const uint256 &ephemeralKey, const uint256 &h_sig,
                       unsigned char nonce) {
...
NotePlaintext::encrypt(ZCNoteEncryption &encryptor,
