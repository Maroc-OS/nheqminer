...
public:
   ...
   * used when the contents are considered uniformly random. It is not
   * appropriate
   * when the value can easily be influenced from outside as e.g. a network
   * adversary could
   * provide values to trigger worst-case behavior.
   * @note The result of this function is not stable between little and big
   * endian.
   */
